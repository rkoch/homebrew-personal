cask "font-input-custom" do
  ...
  url 'https://input.djr.com/build/?basic=1&fontSelection=whole&a=0&g=0&i=topserif&l=serifs_round&zero=slash&asterisk=height&braces=straight&line-height=1.2&accept=I+do'
  name "Input"
  ...
  caveats <<~EOS
    ...
    by re-downloading the fonts at <http://input.djr.com/download>.
